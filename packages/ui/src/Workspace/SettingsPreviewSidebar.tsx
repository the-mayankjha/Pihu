...
export function SettingsPreviewSidebar() {
  return (
    <div style={{ padding: '16px', color: 'var(--pihu-text)', height: '100%', overflowY: 'auto', boxSizing: 'border-box' }}>
      <h3 style={{ margin: '0 0 16px 0', color: 'var(--pihu-primary)', fontSize: '14px', fontWeight: 'bold' }}>Tools & Inspect</h3>
      <div style={{ fontSize: '12px', color: 'color-mix(in srgb, var(--pihu-text) 60%, transparent)', marginBottom: '24px' }}>Right Sidebar Widgets</div>
